...
METRICS = ("latency_ms", "pdr", "throughput_packets", "consensus_size", "control_bytes", "committed", "false_removals", "false_removal_rate", "malicious_selected", "malicious_removal_time")
